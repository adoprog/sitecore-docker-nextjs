...
* `sitecore-docker-nextjs.module.json` contains developer-owned configuration items
  which are created by the JSS Styleguide sample.
* `sitecore-docker-nextjs-Content.module.json` contains content items which are
