...
1. Before you can run the solution, you will need to prepare the following
   ...
   * A valid/trusted wildcard certificate for `*.sitecore_docker_nextjs.localhost`
   * Hosts file entries for `sitecore_docker_nextjs.localhost`
