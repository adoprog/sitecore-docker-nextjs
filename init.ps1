...
try {
    ...
    & $mkcert -install
    & $mkcert "*.sitecore_docker_nextjs.localhost"
...
Add-HostsEntry "cm.sitecore_docker_nextjs.localhost"
Add-HostsEntry "cd.sitecore_docker_nextjs.localhost"
Add-HostsEntry "id.sitecore_docker_nextjs.localhost"
Add-HostsEntry "www.sitecore_docker_nextjs.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.sitecore_docker_nextjs.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.sitecore_docker_nextjs.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.sitecore_docker_nextjs.localhost"
